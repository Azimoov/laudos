...
const SUITE = [
  ...
  { arq: 'teste-busca-nome.js', o: 'busca de paciente por nome, por semelhanca (nota, nao filtro)' },
  ...
  { arq: 'teste-audio-clinico-novo.js', o: 'audio clinico novo: FLAC so com fala e transcricao completa' },
  { arq: 'teste-destaque-transcricao.js', o: 'transcricao: destaque seguro das falas patologicas usadas no laudo' },
